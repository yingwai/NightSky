//Простые множители
/*
Придумайте генератор заданий, который будет выводить любое целое составное число. Человеку нужно будет разложить это число на простые множители и записать 
в ответ все простые множители этого числа.
*/
